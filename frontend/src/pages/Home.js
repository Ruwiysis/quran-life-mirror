    ...
    <main style={{
        ...
        <div style={{ marginBottom: '32px', textAlign: 'center' }}>
          <button
            ...
            style={{
              ...
              color: '#f5efe6', border: 'none', padding: '10px 24px',
      ...
      <div style={{ textAlign: 'center', marginBottom: '56px' }} className="fade-up">
        <span style={{
          ...
          color: 'rgba(201,168,76,0.7)', marginBottom: '18px',
          fontFamily,
        }}>
          {t.eyebrow}
        </span>
        <h1 style={{
          ...
          lineHeight: 1.15, color: '#f5efe6', marginBottom: '18px',
        }}>
          {t.h1a}<br />
          <span style={{ color: '#c9a84c' }}>{t.h1b}</span>
        </h1>
        <p style={{
          fontSize: '1rem', color: 'rgba(245,239,230,0.5)',
      ...
      <div
        ...
        style={{
          background: 'rgba(30,38,64,0.5)', border: '1px solid rgba(201,168,76,0.2)',
          borderRadius: '20px', padding: '32px', backdropFilter: 'blur(16px)',
          marginBottom: '40px', boxShadow: '0 20px 60px rgba(0,0,0,0.3)',
        }}
      >
        <label style={{
        ...
        <div style={{
          ...
          <span style={{ fontSize: '0.72rem', color: 'rgba(245,239,230,0.25)', fontFamily }}>
            {t.tip}
          </span>
          <button
            ...
            style={{
              ...
              color: '#0a0f1e', border: 'none', padding: '12px 32px',
      ...
      {error && (
        <div style={{
          ...
          color: 'rgba(245,239,230,0.7)', fontSize: '0.9rem',
